...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/watanabelab/liujiahao/multispectural-object-detection_2/yolov5l.pt', help='initial weights path')
    ...
    parser.add_argument('--project', default='/home/watanabelab/multispectural-object-detection/liujiahao/runs/train', help='save to project/name')
